...
<div class="container-fluid mt-3 pl-4 pr-4">
	<?php if ($userData['status'] == 'TXN_FAILURE') : ?>
		<div class="row mb-5">
			<div class="pay_stat col-md-7 mb-5" style="padding-left: 55px;padding-right: 55px;">
			...
			<div class="col-md-5">
				<div class="btnlinkgrp">
					<h4 class="text-center text-info">Links</h4>
					<a href="<?php echo base_url('admin/pick_plan'); ?>" class="btn btn-dark">Renew plan again</a><br>
					<a href="<?php echo base_url('user/account'); ?>" class="btn btn-dark mt-3">My account</a>
