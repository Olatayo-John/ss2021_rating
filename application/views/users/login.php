...
<div class="">
	<div class="empty col-md-6 col-sm-6">
		<img src="<?php echo base_url('assets/images/GOVT (1).jpg'); ?>" class="responsive">
	</div>
	<div class="login col-md-6 col-sm-6" id="content">
		<form action="<?php echo base_url('user/login'); ?>" method="post">
			...
			<div class="btngrp">
				<button class="btn btn-success loginbtn" type="submit">Log in</button>
